...
export default function WhatsAppFloatButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform duration-300 hover:scale-105 outline-none focus-visible:ring-3 focus-visible:ring-ring/50"
    >
